...
def validacion_carga_sub_categoria(datos, base_de_datos):
...
def validacion_carga_sub_categoria_2(dato, base_de_datos):
    ...
    validaciones_simples.validacion_simple_general_negativa("Categoria", dato.categoria_principal)
    return key, key_2
